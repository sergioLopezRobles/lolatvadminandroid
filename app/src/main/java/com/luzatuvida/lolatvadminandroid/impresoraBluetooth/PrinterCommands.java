...
public class PrinterCommands {
    ...
    public static byte[] NORMALSIZE = {0x1B, 0x21, 0x03};
    public static byte[] NORMAL = {0x1b,0x21,0x00};
    public static byte[] BOLD = {0x1B, 0x21, 0x08};
    public static byte[] BOLDMEDIUM = {0x1B, 0x21, 0x20};
    public static byte[] BOLDLARGE = {0x1B, 0x21, 0x10};
